...
with codecs.open('dashboard.html', 'r', encoding='mbcs') as f:
    html = f.read()
...
# Use raw string syntax and fix string formatting issue by not using f-strings
js_inject = js_inject.replace('', '').replace('', '')
