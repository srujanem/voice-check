...
pdf_files = [
    os.path.join(uploaded_dir, 'media__1784799956460.pdf'),
    os.path.join(uploaded_dir, 'media__1784799980543.pdf'),
    os.path.join(uploaded_dir, 'media__1784799987363.pdf'),
    os.path.join(uploaded_dir, 'media__1784799994571.pdf'),
    os.path.join(uploaded_dir, 'media__1784800001060.pdf')
]
